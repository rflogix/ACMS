...
$(document).ready(function () {
	...
	grid = new dhx.Grid(null, {
		columns: [
			...
			,{id: 'userSeq', width: 100, header: [{text: '사용자코드'}]}
			,{id: 'userId', width: 200, header: [{text: '사용자ID'}]}
			,{id: 'userNm', width: 200, header: [{text: '사용자명'}]}
			,{id: 'menuType', width: 200, header: [{text: '메뉴타입'}]}
